...
df = pd.read_csv('C:/Users/harsh_kku5dk4/Downloads/AI-based-Medical-Specialist-Recommendation-System-main/AI-based-Medical-Specialist-Recommendation-System-main/Dataset/Symptom.csv')
...
df2 = pd.read_csv('C:/Users/harsh_kku5dk4/Downloads/AI-based-Medical-Specialist-Recommendation-System-main/AI-based-Medical-Specialist-Recommendation-System-main/Dataset/Disease Specialist.csv')
specialist = df2['Specialist'].tolist()
edd = df2['Disease'].tolist()

df1 = pd.read_csv('C:/Users/harsh_kku5dk4/Downloads/AI-based-Medical-Specialist-Recommendation-System-main/AI-based-Medical-Specialist-Recommendation-System-main/Dataset/Symptom Severity.csv')
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Welcome to the AI-based Medical Specialist Doctor Recommendation System", bg='Alice Blue')
        ...
        NameLb = Label(self, text="If you are suffering from a disease and you do not have an idea as to which doctor "
                                  "to go to, so as to get started with the correct treatment, then this Doctor "
                                  "recommendation system can help you advise What kind of doctor you must visit, based on the symptoms "
                                  "that your body is showing.", wraplength=1350, bg='Alice Blue')
